...
public class MultiRobotBuildAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public MultiRobotBuildAdapter(Context context2) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int i) {
        ...
        ClickUtils.applyGlobalDebouncing(viewHolder.itemView, (View.OnClickListener) new View.OnClickListener() {
            public void onClick(View view) {
                if (MultiRobotBuildAdapter.this.clickListener != null) {
                    MultiRobotBuildAdapter.this.clickListener.onItemClick(listInfoBean);
                }
                int unused = MultiRobotBuildAdapter.this.clickPosition = i;
                MultiRobotBuildAdapter.this.notifyDataSetChanged();
            }
        });

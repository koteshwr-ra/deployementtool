...
public class IntellectPointAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public IntellectPointAdapter(Context context2) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        if (i == 0) {
            return new ViewHolder(LayoutInflater.from(this.context).inflate(R.layout.item_point2, viewGroup, false));
        }
        return new ViewHolderContent(LayoutInflater.from(this.context).inflate(R.layout.item_multi_item2, viewGroup, false));
    }
        ...
        if (viewHolder instanceof ViewHolder) {
            ...
            ClickUtils.applyGlobalDebouncing((View) viewHolderContent.clMultiRoot, (View.OnClickListener) new View.OnClickListener() {
                public void onClick(View view) {
                    if (IntellectPointAdapter.this.clickListener != null) {
                        IntellectPointAdapter.this.clickListener.onItemAdd2Line(waypointsBean);
                    }
                }
            });
        }

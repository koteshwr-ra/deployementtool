...
public class RockerView extends View {
    ...
    private void initAttribute(Context context, AttributeSet attributeSet) {
        ...
        this.mRockerRadius = obtainStyledAttributes.getDimensionPixelOffset(2, 50);
    ...
    public boolean onTouchEvent(android.view.MotionEvent r5) {
        ...
        L_0x0052:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: mc.csst.com.selfchassis.utils.view.RockerView.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    private void callBack(double d, float f) {
        ...
        if (CallBackMode.CALL_BACK_MODE_MOVE == this.mCallBackMode) {
            int i = AnonymousClass1.$SwitchMap$mc$csst$com$selfchassis$utils$view$RockerView$DirectionMode[this.mDirectionMode.ordinal()];
            if (i != 1) {
                if (i != 2) {
                    if (i != 3) {
                        if (i != 4) {
            ...
            int i2 = AnonymousClass1.$SwitchMap$mc$csst$com$selfchassis$utils$view$RockerView$DirectionMode[this.mDirectionMode.ordinal()];
            if (i2 != 1) {
                if (i2 != 2) {
                    if (i2 != 3) {
                        if (i2 != 4) {
    ...
    /* renamed from: mc.csst.com.selfchassis.utils.view.RockerView$1  reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$mc$csst$com$selfchassis$utils$view$RockerView$DirectionMode;
        ...
        static {
            /*
                mc.csst.com.selfchassis.utils.view.RockerView$DirectionMode[] r0 = mc.csst.com.selfchassis.utils.view.RockerView.DirectionMode.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                $SwitchMap$mc$csst$com$selfchassis$utils$view$RockerView$DirectionMode = r0
                mc.csst.com.selfchassis.utils.view.RockerView$DirectionMode r1 = mc.csst.com.selfchassis.utils.view.RockerView.DirectionMode.DIRECTION_2_HORIZONTAL     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = $SwitchMap$mc$csst$com$selfchassis$utils$view$RockerView$DirectionMode     // Catch:{ NoSuchFieldError -> 0x001d }
                mc.csst.com.selfchassis.utils.view.RockerView$DirectionMode r1 = mc.csst.com.selfchassis.utils.view.RockerView.DirectionMode.DIRECTION_2_VERTICAL     // Catch:{ NoSuchFieldError -> 0x001d }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001d }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001d }
            L_0x001d:
                int[] r0 = $SwitchMap$mc$csst$com$selfchassis$utils$view$RockerView$DirectionMode     // Catch:{ NoSuchFieldError -> 0x0028 }
                mc.csst.com.selfchassis.utils.view.RockerView$DirectionMode r1 = mc.csst.com.selfchassis.utils.view.RockerView.DirectionMode.DIRECTION_4_ROTATE_0     // Catch:{ NoSuchFieldError -> 0x0028 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0028 }
                r2 = 3
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0028 }
            L_0x0028:
                int[] r0 = $SwitchMap$mc$csst$com$selfchassis$utils$view$RockerView$DirectionMode     // Catch:{ NoSuchFieldError -> 0x0033 }
                mc.csst.com.selfchassis.utils.view.RockerView$DirectionMode r1 = mc.csst.com.selfchassis.utils.view.RockerView.DirectionMode.DIRECTION_4_ROTATE_45     // Catch:{ NoSuchFieldError -> 0x0033 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0033 }
                r2 = 4
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0033 }
            L_0x0033:
                int[] r0 = $SwitchMap$mc$csst$com$selfchassis$utils$view$RockerView$DirectionMode     // Catch:{ NoSuchFieldError -> 0x003e }
                mc.csst.com.selfchassis.utils.view.RockerView$DirectionMode r1 = mc.csst.com.selfchassis.utils.view.RockerView.DirectionMode.DIRECTION_8     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: mc.csst.com.selfchassis.utils.view.RockerView.AnonymousClass1.<clinit>():void");
        }
    }

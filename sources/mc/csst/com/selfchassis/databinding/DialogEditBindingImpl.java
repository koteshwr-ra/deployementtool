...
public class DialogEditBindingImpl extends DialogEditBinding {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.let_input, 4);
        sViewsWithIds.put(R.id.tv_slow_zone_speed_title, 5);
        sViewsWithIds.put(R.id.rg_sz_speed, 6);
        sViewsWithIds.put(R.id.rb_sz_speed_centre, 7);
        sViewsWithIds.put(R.id.rb_sz_speed_low, 8);
    }
    ...
    private DialogEditBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 1, objArr[1], objArr[4], objArr[7], objArr[8], objArr[6], objArr[5], objArr[3], objArr[2]);
        this.mDirtyFlags = -1;
    ...
    public boolean hasPendingBindings() {
        ...
        L_0x0018:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: mc.csst.com.selfchassis.databinding.DialogEditBindingImpl.hasPendingBindings():boolean");
    }

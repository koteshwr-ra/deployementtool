...
public class LayeredMapCmdResponseBean {
    private String id;
    private String info;
    private String op;
    ...
    public static class ValuesBean {
        ...
        public AreaMsgBean getAreas() {
            return this.areas;
        }

        public void setAreas(AreaMsgBean areaMsgBean) {
            this.areas = areaMsgBean;
        }

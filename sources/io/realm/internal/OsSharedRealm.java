...
public final class OsSharedRealm implements Closeable, NativeObject {
    ...
    private static native long nativeGetSharedRealm(long j, long j2, long j3, RealmNotifier realmNotifier2);
    ...
    private OsSharedRealm(OsRealmConfig osRealmConfig2, VersionID versionID) {
        ...
        try {
            this.nativePtr = nativeGetSharedRealm(osRealmConfig2.getNativePtr(), versionID.version, versionID.index, androidRealmNotifier);

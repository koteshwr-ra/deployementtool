...
public interface com_ciot_realm_db_common_RecordResponseRealmProxyInterface {
    ...
    String realmGet$haspostpone();

    String realmGet$id();

    RecordLockMode realmGet$lockmode();
    ...
    void realmSet$haspostpone(String str);

    void realmSet$id(String str);

    void realmSet$lockmode(RecordLockMode recordLockMode);

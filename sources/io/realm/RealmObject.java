    ...
    public static <E extends RealmModel> E freeze(E e) {
        if (e instanceof RealmObjectProxy) {
            ...
            if (freeze instanceof Realm) {
                ...
                return freeze.getConfiguration().getSchemaMediator().newInstance(superclass, freeze, freeze2, realm$realm.getSchema().getColumnInfo((Class<? extends RealmModel>) superclass), false, Collections.emptyList());
            }

    ...
    public static final void processUtf8Bytes(String str, int i, int i2, Function1<? super Byte, Unit> function1) {
        ...
        while (i < i2) {
            ...
            if (charAt2 < 128) {
                ...
                if (charAt2 < 2048) {
                    function1.invoke(Byte.valueOf((byte) ((charAt2 >> 6) | Opcodes.CHECKCAST)));
                    function1.invoke(Byte.valueOf((byte) ((charAt2 & '?') | 128)));
                } else if (55296 > charAt2 || 57343 < charAt2) {
                    function1.invoke(Byte.valueOf((byte) ((charAt2 >> 12) | TbsListener.ErrorCode.EXCEED_INCR_UPDATE)));
                    ...
                    function1.invoke(Byte.valueOf((byte) ((charAt3 >> 18) | TbsListener.ErrorCode.TPATCH_VERSION_FAILED)));

...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public final byte m1712deprecated_getByte(long j) {
        return getByte(j);
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "size", imports = {}))
    /* renamed from: -deprecated_size  reason: not valid java name */
    public final long m1713deprecated_size() {
        return this.size;
    }
                    ...
                    while (i < i2) {
                        ...
                        if (charAt < 128) {
                            ...
                            if (charAt < 2048) {
                                ...
                                writableSegment$okio2.data[writableSegment$okio2.limit] = (byte) ((charAt >> 6) | Opcodes.CHECKCAST);
                                ...
                                writableSegment$okio3.data[writableSegment$okio3.limit] = (byte) ((charAt >> 12) | TbsListener.ErrorCode.EXCEED_INCR_UPDATE);
                                ...
                                if (charAt > 56319 || 56320 > c || 57343 < c) {
                                    ...
                                    writableSegment$okio4.data[writableSegment$okio4.limit] = (byte) ((i6 >> 18) | TbsListener.ErrorCode.TPATCH_VERSION_FAILED);
    ...
    public Buffer writeUtf8CodePoint(int i) {
        if (i < 128) {
            ...
            writableSegment$okio3.data[writableSegment$okio3.limit] = (byte) ((i >> 18) | TbsListener.ErrorCode.TPATCH_VERSION_FAILED);

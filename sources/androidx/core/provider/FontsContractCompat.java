        ...
        try {
            ...
            if (cursor != null && cursor.getCount() > 0) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    arrayList2.add(new FontInfo(uri, i2, columnIndex5 != -1 ? cursor.getInt(columnIndex5) : TbsListener.ErrorCode.INFO_CODE_BASE, columnIndex6 != -1 && cursor.getInt(columnIndex6) == 1, i));
                }

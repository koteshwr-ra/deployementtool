...
public final class DelayKt {
    ...
    public static final Object m1521delayp9JZ4hM(double d, Continuation<? super Unit> continuation) {
        Object delay = delay(m1522toDelayMillisLRDsOJo(d), continuation);
    ...
    public static final long m1522toDelayMillisLRDsOJo(double d) {
        if (Duration.compareTo-LRDsOJo(d, Duration.Companion.m1485getZEROUwyO8pc()) > 0) {

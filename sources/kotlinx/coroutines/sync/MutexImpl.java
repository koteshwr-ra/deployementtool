        ...
        while (true) {
            ...
            if (obj3 instanceof Empty) {
                ...
                if (lockedQueue.owner != obj2) {
                    ...
                    LockFreeLinkedListNode.CondAddOp mutexImpl$lockSuspend$$inlined$suspendCancellableCoroutineReusable$lambda$1 = new MutexImpl$lockSuspend$$inlined$suspendCancellableCoroutineReusable$lambda$1(lockFreeLinkedListNode2, lockFreeLinkedListNode2, obj3, cancellableContinuation, lockCont, this, obj);
                    while (true) {

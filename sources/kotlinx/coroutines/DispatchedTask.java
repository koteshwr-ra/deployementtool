        ...
        try {
            ...
            if (delegate$kotlinx_coroutines_core != null) {
                ...
                if (job != null && !job.isActive()) {
                    ...
                    continuation.resumeWith(Result.m98constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
                } else {
                ...
                try {
                    ...
                    obj2 = Result.m98constructorimpl(Unit.INSTANCE);
                } catch (Throwable th3) {
                    Result.Companion companion5 = Result.Companion;
                    obj2 = Result.m98constructorimpl(ResultKt.createFailure(th3));
                }
                handleFatalException$kotlinx_coroutines_core(th2, Result.m101exceptionOrNullimpl(obj2));
                return;
            }
            ...
            try {
                ...
                taskContext.afterTask();
                obj = Result.m98constructorimpl(Unit.INSTANCE);
            } catch (Throwable th5) {
                Result.Companion companion7 = Result.Companion;
                obj = Result.m98constructorimpl(ResultKt.createFailure(th5));
            }
            handleFatalException$kotlinx_coroutines_core(th4, Result.m101exceptionOrNullimpl(obj));
        }
    }

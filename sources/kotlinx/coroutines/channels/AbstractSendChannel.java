...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    public final Send takeFirstSendOrPeekClosed() {
        ...
        while (true) {
            ...
            if (next != null) {
                ...
                if (lockFreeLinkedListNode != lockFreeLinkedListNode2 && (lockFreeLinkedListNode instanceof Send)) {
    ...
    private final void helpClose(Closed<?> closed) {
        Object r2 = InlineList.m1552constructorimpl$default((Object) null, 1, (DefaultConstructorMarker) null);
        while (true) {
            ...
            if (receive == null) {
                ...
                r2 = InlineList.m1557plusUZ7vuAc(r2, receive);
            }
        }
        if (r2 != null) {
    ...
    public ReceiveOrClosed<E> takeFirstReceiveOrPeekClosed() {
        ...
        while (true) {
            ...
            if (next != null) {
                lockFreeLinkedListNode = (LockFreeLinkedListNode) next;
                if (lockFreeLinkedListNode != lockFreeLinkedListNode2 && (lockFreeLinkedListNode instanceof ReceiveOrClosed)) {

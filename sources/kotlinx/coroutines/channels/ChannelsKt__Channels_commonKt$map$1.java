...
final class ChannelsKt__Channels_commonKt$map$1 extends SuspendLambda implements Function2<ProducerScope<? super R>, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:31:0x00e2 A[Catch:{ all -> 0x0140 }] */
    ...
    public final java.lang.Object invokeSuspend(java.lang.Object r18) {
        /*
            ...
            kotlin.ResultKt.throwOnFailure(r18)     // Catch:{ all -> 0x0144 }
            r12 = r1
            r16 = r8
            r8 = r6
            r6 = r11
        ...
        L_0x00ab:
            ...
            kotlinx.coroutines.channels.ChannelIterator r7 = r8.iterator()     // Catch:{ all -> 0x0144 }
            r10 = r1
            r12 = r10
            r9 = r8
            r11 = r9
            ...
            r7 = r16
        L_0x00c3:
            r12.L$0 = r6     // Catch:{ all -> 0x0140 }
            r12.L$1 = r11     // Catch:{ all -> 0x0140 }
            r12.L$2 = r10     // Catch:{ all -> 0x0140 }
            r12.L$3 = r9     // Catch:{ all -> 0x0140 }
            r12.L$4 = r7     // Catch:{ all -> 0x0140 }
            r12.L$5 = r8     // Catch:{ all -> 0x0140 }
            r12.L$6 = r2     // Catch:{ all -> 0x0140 }
            r12.label = r5     // Catch:{ all -> 0x0140 }
            java.lang.Object r13 = r2.hasNext(r10)     // Catch:{ all -> 0x0140 }
            if (r13 != r0) goto L_0x00da
            return r0
        L_0x00da:
            java.lang.Boolean r13 = (java.lang.Boolean) r13     // Catch:{ all -> 0x0140 }
            boolean r13 = r13.booleanValue()     // Catch:{ all -> 0x0140 }
            if (r13 == 0) goto L_0x0138
            java.lang.Object r13 = r2.next()     // Catch:{ all -> 0x0140 }
            kotlin.jvm.functions.Function2 r14 = r12.$transform     // Catch:{ all -> 0x0140 }
            r12.L$0 = r6     // Catch:{ all -> 0x0140 }
            r12.L$1 = r11     // Catch:{ all -> 0x0140 }
            r12.L$2 = r10     // Catch:{ all -> 0x0140 }
            r12.L$3 = r9     // Catch:{ all -> 0x0140 }
            ...
            r12.L$5 = r8     // Catch:{ all -> 0x0140 }
            r12.L$6 = r2     // Catch:{ all -> 0x0140 }
            r12.L$7 = r13     // Catch:{ all -> 0x0140 }
            r12.L$8 = r13     // Catch:{ all -> 0x0140 }
            r12.L$9 = r6     // Catch:{ all -> 0x0140 }
            r12.label = r4     // Catch:{ all -> 0x0140 }
            r15 = 6
            kotlin.jvm.internal.InlineMarker.mark((int) r15)     // Catch:{ all -> 0x0140 }
            java.lang.Object r14 = r14.invoke(r13, r12)     // Catch:{ all -> 0x0140 }
            r15 = 7
            kotlin.jvm.internal.InlineMarker.mark((int) r15)     // Catch:{ all -> 0x0140 }

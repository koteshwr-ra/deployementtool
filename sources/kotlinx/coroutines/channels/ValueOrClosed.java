...
public final class ValueOrClosed<T> {
    ...
    public static final /* synthetic */ ValueOrClosed m1529boximpl(Object obj) {
        return new ValueOrClosed(obj);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static Object m1530constructorimpl(Object obj) {
        return obj;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1531equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof ValueOrClosed) && Intrinsics.areEqual(obj, ((ValueOrClosed) obj2).m1539unboximpl());
    }
    ...
    public static int m1536hashCodeimpl(Object obj) {
        if (obj != null) {
            return obj.hashCode();
        }
        return 0;
    ...
    public boolean equals(Object obj) {
        return m1531equalsimpl(this.holder, obj);
    }

    public int hashCode() {
        return m1536hashCodeimpl(this.holder);
    }

    public String toString() {
        return m1538toStringimpl(this.holder);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ Object m1539unboximpl() {
        return this.holder;
    }
    ...
    public static final boolean m1537isClosedimpl(Object obj) {
        return obj instanceof Closed;
    }

    /* renamed from: getValue-impl  reason: not valid java name */
    public static final T m1534getValueimpl(Object obj) {
    ...
    public static final T m1535getValueOrNullimpl(Object obj) {
        if (obj instanceof Closed) {
            return null;
        }
        return obj;
    ...
    public static final Throwable m1533getCloseCauseimpl(Object obj) {
        if (obj instanceof Closed) {
    ...
    public static String m1538toStringimpl(Object obj) {
        if (obj instanceof Closed) {
            return obj.toString();
        }
        return "Value(" + obj + ')';
    ...
    public static final class Companion {
        ...
        public final <E> Object m1541valueZYPwvRU$kotlinx_coroutines_core(E e) {
            return ValueOrClosed.m1530constructorimpl(e);
        }

        /* renamed from: closed-ZYPwvRU$kotlinx_coroutines_core  reason: not valid java name */
        public final <E> Object m1540closedZYPwvRU$kotlinx_coroutines_core(Throwable th) {
            return ValueOrClosed.m1530constructorimpl(new Closed(th));
        }
    }
}

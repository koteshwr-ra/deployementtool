...
public final class ExceptionsConstuctorKt {
    ...
    public static final <E extends java.lang.Throwable> E tryCopyException(E r9) {
        /*
            ...
            java.lang.Object r9 = kotlin.Result.m98constructorimpl(r9)     // Catch:{ all -> 0x0012 }
            goto L_0x001d
        L_0x0012:
            r9 = move-exception
        ...
        L_0x001d:
            boolean r0 = kotlin.Result.m104isFailureimpl(r9)
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            ...
            num = Result.m98constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, (Object) null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            num = Result.m98constructorimpl(ResultKt.createFailure(th));
        }
        Integer valueOf = Integer.valueOf(i);
        if (Result.m104isFailureimpl(num)) {
            num = valueOf;
        }

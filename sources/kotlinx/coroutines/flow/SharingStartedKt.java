...
public final class SharingStartedKt {
    ...
    public static /* synthetic */ SharingStarted m1549WhileSubscribed9tZugJw$default(SharingStarted.Companion companion, double d, double d2, int i, Object obj) {
        if ((i & 1) != 0) {
            d = Duration.Companion.m1485getZEROUwyO8pc();
        }
        if ((i & 2) != 0) {
            d2 = Duration.Companion.m1483getINFINITEUwyO8pc();
        }
        return m1548WhileSubscribed9tZugJw(companion, d, d2);
    }

    /* renamed from: WhileSubscribed-9tZugJw  reason: not valid java name */
    public static final SharingStarted m1548WhileSubscribed9tZugJw(SharingStarted.Companion companion, double d, double d2) {

...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m1545debounce8GFy2Ro(Flow<? extends T> flow, double d) {
        return FlowKt.debounce(flow, DelayKt.m1522toDelayMillisLRDsOJo(d));
    }
    ...
    public static final <T> Flow<T> m1546sample8GFy2Ro(Flow<? extends T> flow, double d) {
        return FlowKt.sample(flow, DelayKt.m1522toDelayMillisLRDsOJo(d));
    }
}

...
public final class FlowKt {
    ...
    public static final <T> Flow<T> m1542catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        return FlowKt__ErrorsKt.m1547catch(flow, function3);
    }
    ...
    public static final <T> Flow<T> m1543debounce8GFy2Ro(Flow<? extends T> flow, double d) {
        return FlowKt__DelayKt.m1545debounce8GFy2Ro(flow, d);
    }
    ...
    public static final <T> Flow<T> m1544sample8GFy2Ro(Flow<? extends T> flow, double d) {
        return FlowKt__DelayKt.m1546sample8GFy2Ro(flow, d);
    }

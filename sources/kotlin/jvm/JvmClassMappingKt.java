    ...
    public static final <T> Class<T> getJavaPrimitiveType(KClass<T> kClass) {
        ...
        if (name != null) {
            switch (name.hashCode()) {
                case -2056817302:
                    if (name.equals(Consts.INTEGER)) {
                        return Integer.TYPE;
                    }
                    break;
                case -527879800:
                    if (name.equals(Consts.FLOAT)) {
                        return Float.TYPE;
                    }
                    break;
                case -515992664:
                    if (name.equals(Consts.SHORT)) {
                        return Short.TYPE;
                    }
                    break;
                case 155276373:
                    if (name.equals(Consts.CHAR)) {
                        return Character.TYPE;
                    }
                    break;
                case 344809556:
                    if (name.equals(Consts.BOOLEAN)) {
                        return Boolean.TYPE;
                    }
                    break;
                case 398507100:
                    if (name.equals(Consts.BYTE)) {
                        return Byte.TYPE;
                    }
                    break;
                case 398795216:
                    if (name.equals(Consts.LONG)) {
                        return Long.TYPE;
                    }
                    break;
                case 399092968:

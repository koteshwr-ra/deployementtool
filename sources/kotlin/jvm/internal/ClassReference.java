...
public final class ClassReference implements KClass<Object>, ClassBasedDeclarationContainer {
            ...
            if (!cls.isAnonymousClass()) {
                if (cls.isLocalClass()) {
                    ...
                    if (enclosingMethod != null) {
                        Intrinsics.checkNotNullExpressionValue(simpleName, ServiceProvider.NAME);
    ...
    static {
        ...
        hashMap2.put(Consts.BOOLEAN, "kotlin.Boolean");
        hashMap2.put(Consts.CHAR, "kotlin.Char");
        hashMap2.put(Consts.BYTE, "kotlin.Byte");
        hashMap2.put(Consts.SHORT, "kotlin.Short");
        hashMap2.put(Consts.INTEGER, "kotlin.Int");
        hashMap2.put(Consts.FLOAT, "kotlin.Float");
        hashMap2.put(Consts.LONG, "kotlin.Long");
        hashMap2.put(Consts.DOUBEL, "kotlin.Double");
        primitiveWrapperFqNames = hashMap2;
        HashMap<String, String> hashMap3 = new HashMap<>();
        hashMap3.put("java.lang.Object", "kotlin.Any");
        hashMap3.put(Consts.STRING, "kotlin.String");

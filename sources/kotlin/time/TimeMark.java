...
public abstract class TimeMark {
    ...
    public abstract long m1512elapsedNowUwyO8pc();

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1514plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this, j, (DefaultConstructorMarker) null);
    }

    /* renamed from: minus-LRDsOJo  reason: not valid java name */
    public TimeMark m1513minusLRDsOJo(long j) {
        return m1514plusLRDsOJo(Duration.m1435unaryMinusUwyO8pc(j));
    }

    public final boolean hasPassedNow() {
        return !Duration.m1416isNegativeimpl(m1512elapsedNowUwyO8pc());
    }

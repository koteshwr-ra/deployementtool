...
final class AdjustedTimeMark extends TimeMark {
    ...
    public final long m1377getAdjustmentUwyO8pc() {
    ...
    public long m1376elapsedNowUwyO8pc() {
        return Duration.m1418minusLRDsOJo(this.mark.m1512elapsedNowUwyO8pc(), m1377getAdjustmentUwyO8pc());
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1378plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1419plusLRDsOJo(m1377getAdjustmentUwyO8pc(), j), (DefaultConstructorMarker) null);
    }
}

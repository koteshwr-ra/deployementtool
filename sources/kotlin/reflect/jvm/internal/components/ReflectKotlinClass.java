...
public final class ReflectKotlinClass implements KotlinJvmBinaryClass {
    ...
    public String getLocation() {
        ...
        sb.append(StringsKt.replace$default(name, (char) ClassUtils.PACKAGE_SEPARATOR_CHAR, '/', false, 4, (Object) null));
        sb.append(".class");
        return sb.toString();
    }
    ...
    public void loadClassAnnotations(KotlinJvmBinaryClass.AnnotationVisitor annotationVisitor, byte[] bArr) {
        Intrinsics.checkParameterIsNotNull(annotationVisitor, Person.VISITOR);
    ...
    public void visitMembers(KotlinJvmBinaryClass.MemberVisitor memberVisitor, byte[] bArr) {
        Intrinsics.checkParameterIsNotNull(memberVisitor, Person.VISITOR);

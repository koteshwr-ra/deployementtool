...
public final class JavaToKotlinClassMap {
    ...
    private static final String NUMBERED_FUNCTION_PREFIX = (FunctionClassDescriptor.Kind.Function.getPackageFqName().toString() + Consts.DOT + FunctionClassDescriptor.Kind.Function.getClassNamePrefix());
    private static final String NUMBERED_K_FUNCTION_PREFIX = (FunctionClassDescriptor.Kind.KFunction.getPackageFqName().toString() + Consts.DOT + FunctionClassDescriptor.Kind.KFunction.getClassNamePrefix());
    private static final String NUMBERED_K_SUSPEND_FUNCTION_PREFIX = (FunctionClassDescriptor.Kind.KSuspendFunction.getPackageFqName().toString() + Consts.DOT + FunctionClassDescriptor.Kind.KSuspendFunction.getClassNamePrefix());
    private static final String NUMBERED_SUSPEND_FUNCTION_PREFIX = (FunctionClassDescriptor.Kind.SuspendFunction.getPackageFqName().toString() + Consts.DOT + FunctionClassDescriptor.Kind.SuspendFunction.getClassNamePrefix());
    ...
    static {
        ...
        for (int i2 = 0; i2 < 22; i2++) {
            ...
            javaToKotlinClassMap.addKotlinToJava(new FqName((kind.getPackageFqName().toString() + Consts.DOT + kind.getClassNamePrefix()) + i2), K_FUNCTION_CLASS_ID);
        }

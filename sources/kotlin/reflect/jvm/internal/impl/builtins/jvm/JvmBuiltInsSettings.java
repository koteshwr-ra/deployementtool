...
public class JvmBuiltInsSettings implements AdditionalClassPartsProvider, PlatformDependentDeclarationFilter {
    ...
    public Collection<ClassConstructorDescriptor> getConstructors(ClassDescriptor classDescriptor) {
        ...
        for (ClassConstructorDescriptor classConstructorDescriptor3 : iterable2) {
            ...
            if (!set.contains(signatureBuildingComponents.signature(classDescriptor3, MethodSignatureMappingKt.computeJvmDescriptor$default(classConstructorDescriptor3, false, false, 3, (Object) null)))) {

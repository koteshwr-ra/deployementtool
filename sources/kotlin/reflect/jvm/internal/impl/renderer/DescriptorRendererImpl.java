    ...
    public final void renderConstructor(ConstructorDescriptor constructorDescriptor, StringBuilder sb) {
        ...
        if (getRenderConstructorDelegation() && !constructorDescriptor.isPrimary() && (containingDeclaration instanceof ClassDescriptor) && (unsubstitutedPrimaryConstructor = ((ClassDescriptor) containingDeclaration).getUnsubstitutedPrimaryConstructor()) != null) {
            ...
            if (!list.isEmpty()) {
                ...
                sb2.append(CollectionsKt.joinToString$default(list, ", ", "(", ")", 0, (CharSequence) null, DescriptorRendererImpl$renderConstructor$1.INSTANCE, 24, (Object) null));
            }
        }
        if (getSecondaryConstructorsAsPrimary()) {
    ...
    private final void renderWhereSuffix(List<? extends TypeParameterDescriptor> list, StringBuilder sb) {
        if (!getWithoutTypeParameters()) {
            ...
            if (!arrayList.isEmpty()) {
                ...
                sb.append(StringUtils.SPACE);
                CollectionsKt.joinTo$default(arrayList, sb, ", ", (CharSequence) null, (CharSequence) null, 0, (CharSequence) null, (Function1) null, TbsListener.ErrorCode.DOWNLOAD_REDIRECT_EMPTY, (Object) null);
            }
        }
    }

...
public final class ClassId {
    ...
    public FqName asSingleFqName() {
        ...
        return new FqName(this.packageFqName.asString() + Consts.DOT + this.relativeClassName.asString());
    }
    ...
    public String asString() {
        ...
        String str = this.packageFqName.asString().replace(ClassUtils.PACKAGE_SEPARATOR_CHAR, '/') + "/" + this.relativeClassName.asString();
        if (str == null) {
            $$$reportNull$$$0(14);
        }
        return str;

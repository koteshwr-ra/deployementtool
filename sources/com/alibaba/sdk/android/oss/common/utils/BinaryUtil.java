...
public class BinaryUtil {
    ...
    public static java.lang.String fileToSHA1(java.lang.String r6) {
        /*
            r0 = 0
            java.io.FileInputStream r1 = new java.io.FileInputStream     // Catch:{ Exception -> 0x0037, all -> 0x0030 }
            r1.<init>(r6)     // Catch:{ Exception -> 0x0037, all -> 0x0030 }
            r6 = 1024(0x400, float:1.435E-42)
            byte[] r6 = new byte[r6]     // Catch:{ Exception -> 0x002e, all -> 0x002b }
            java.lang.String r2 = "SHA-1"
            java.security.MessageDigest r2 = java.security.MessageDigest.getInstance(r2)     // Catch:{ Exception -> 0x002e, all -> 0x002b }
            r3 = 0
            r4 = 0
        L_0x0012:
            r5 = -1
            if (r4 == r5) goto L_0x001f
            int r4 = r1.read(r6)     // Catch:{ Exception -> 0x002e, all -> 0x002b }
            if (r4 <= 0) goto L_0x0012
            r2.update(r6, r3, r4)     // Catch:{ Exception -> 0x002e, all -> 0x002b }
            goto L_0x0012
        L_0x001f:
            byte[] r6 = r2.digest()     // Catch:{ Exception -> 0x002e, all -> 0x002b }
            java.lang.String r6 = convertHashToString(r6)     // Catch:{ Exception -> 0x002e, all -> 0x002b }

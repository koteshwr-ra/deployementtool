...
public abstract class JSONLexerBase implements JSONLexer, Closeable {
    ...
    public final float[] scanFieldFloatArray(char[] r20) {
        ...
        L_0x012a:
            ...
            r10 = 0
            java.lang.System.arraycopy(r6, r10, r8, r10, r5)
            r6 = r8
        L_0x0142:
            ...
            if (c2 == 'u') {
                ...
                if (this.ch == 'l') {
                    ...
                    if (this.ch == 'l') {
                        next();
                        char c3 = this.ch;
                        if (c3 == ' ' || c3 == ',' || c3 == '}' || c3 == ']' || c3 == 10 || c3 == 13 || c3 == 9 || c3 == 26 || ((c3 == ':' && z) || (c = this.ch) == 12 || c == 8)) {
                            this.token = 8;
                            return;
                        }
    ...
    public final void scanIdent() {
        ...
        if (Configurator.NULL.equalsIgnoreCase(stringVal)) {
            this.token = 8;
        } else if ("new".equals(stringVal)) {
            this.token = 9;
        } else if ("true".equals(stringVal)) {
            this.token = 6;
        } else if (Bugly.SDK_IS_DEV.equals(stringVal)) {
            this.token = 7;

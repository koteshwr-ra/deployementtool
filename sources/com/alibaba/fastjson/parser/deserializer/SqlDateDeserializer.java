...
public class SqlDateDeserializer extends AbstractDateDeserializer implements ObjectDeserializer {
    ...
    /* JADX WARNING: Missing exception handler attribute for start block: B:40:0x0089 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public <T> T castTimestamp(com.alibaba.fastjson.parser.DefaultJSONParser r3, java.lang.reflect.Type r4, java.lang.Object r5, java.lang.Object r6) {
        ...
        L_0x0041:
            ...
            r4.<init>(r6)
            r5 = 0
            boolean r5 = r4.scanISO8601DateIfMatch(r5)     // Catch:{ all -> 0x0096 }
            if (r5 == 0) goto L_0x0056
            java.util.Calendar r3 = r4.getCalendar()     // Catch:{ all -> 0x0096 }
            long r5 = r3.getTimeInMillis()     // Catch:{ all -> 0x0096 }
            goto L_0x008d
        L_0x0056:
            int r5 = r6.length()     // Catch:{ all -> 0x0096 }
            r0 = 29
            if (r5 != r0) goto L_0x0074
            java.lang.String r5 = r3.getDateFomartPattern()     // Catch:{ all -> 0x0096 }
            int r1 = r5.length()     // Catch:{ all -> 0x0096 }
            if (r1 == r0) goto L_0x0074
            java.lang.String r0 = com.alibaba.fastjson.JSON.DEFFAULT_DATE_FORMAT     // Catch:{ all -> 0x0096 }
            if (r5 != r0) goto L_0x0074
            java.sql.Timestamp r3 = java.sql.Timestamp.valueOf(r6)     // Catch:{ all -> 0x0096 }
            r4.close()
            return r3
        L_0x0074:
            java.text.DateFormat r3 = r3.getDateFormat()     // Catch:{ all -> 0x0096 }
            java.util.Date r3 = r3.parse(r6)     // Catch:{ ParseException -> 0x0089 }
            java.sql.Timestamp r5 = new java.sql.Timestamp     // Catch:{ ParseException -> 0x0089 }
            long r0 = r3.getTime()     // Catch:{ ParseException -> 0x0089 }
            r5.<init>(r0)     // Catch:{ ParseException -> 0x0089 }
            r4.close()
            return r5
        L_0x0089:
            long r5 = java.lang.Long.parseLong(r6)     // Catch:{ all -> 0x0096 }
        L_0x008d:
            r4.close()
            java.sql.Timestamp r3 = new java.sql.Timestamp
            r3.<init>(r5)

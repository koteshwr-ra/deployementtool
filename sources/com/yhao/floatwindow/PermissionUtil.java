...
class PermissionUtil {
    ...
    private static boolean hasPermissionForO(Context context) {
        try {
            ...
            WindowManager.LayoutParams layoutParams = new WindowManager.LayoutParams(0, 0, Build.VERSION.SDK_INT >= 26 ? 2038 : ScannerDiagnosis.SubScannerDiagnosis.CODE_ERROR_GET_MESSAGE, 24, -2);

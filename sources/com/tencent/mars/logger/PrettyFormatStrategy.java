...
public class PrettyFormatStrategy implements FormatStrategy {
    ...
    private void logHeaderContent(int i, String str, int i2) {
        ...
        while (i2 > 0) {
            ...
            if (i3 < stackTrace.length) {
                str2 = str2 + "   ";
                logChunk(i, str, HORIZONTAL_LINE + ' ' + str2 + getSimpleClassName(stackTrace[i3].getClassName()) + Consts.DOT + stackTrace[i3].getMethodName() + StringUtils.SPACE + " (" + stackTrace[i3].getFileName() + ":" + stackTrace[i3].getLineNumber() + ")");
            }
            i2--;
        }
    }
    ...
    private int getStackOffset(StackTraceElement[] stackTraceElementArr) {
        ...
        for (int i = 5; i < stackTraceElementArr.length; i++) {
            ...
            if (!className.equals(LoggerPrinter.class.getName()) && !className.equals(XLogger.class.getName())) {
                return i - 1;
            }
        }
        return -1;
    ...
    private String formatTag(String str) {
        ...
        return this.tag + MapFragment.SLASH + str;
    }
    ...
    public static class Builder {
        ...
        public PrettyFormatStrategy build() {
            if (this.logStrategy == null) {
                this.logStrategy = new XLogStrategy();
            }

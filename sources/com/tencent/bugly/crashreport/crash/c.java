...
public final class c {
    ...
    private c(int i2, Context context, w wVar, boolean z2, BuglyStrategy.a aVar, o oVar, String str) {
        ...
        NativeCrashHandler instance = NativeCrashHandler.getInstance(a2, a5, this.p, this.u, wVar, z2, str);
        this.t = instance;
        a5.F = instance;
        this.w = b.a(a2, this.u, a5, wVar, a4, this.p, aVar);
    }
        ...
        while (true) {
            ...
            if (i2 < 30) {
                try {
                    ...
                    z.b((long) CoroutineLiveDataKt.DEFAULT_TIMEOUT);
                    i2 = i3;
                } catch (Throwable th) {
                    if (!x.a(th)) {
                        th.printStackTrace();

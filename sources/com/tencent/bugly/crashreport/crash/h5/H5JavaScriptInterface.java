    ...
    private static a a(String str) {
        if (str != null && str.length() > 0) {
            try {
                ...
                aVar.c = jSONObject.getString(TbsVideoCacheTask.KEY_VIDEO_CACHE_PARAM_URL);
                if (aVar.c == null) {
                    return null;
                }
                ...
                aVar.f = jSONObject.getString(ServiceProvider.NAME);
                if (aVar.f != null) {
                    if (!aVar.f.equals(Configurator.NULL)) {
                        String string = jSONObject.getString("stacktrace");
                        if (string == null) {
                            return null;
                        }
                        int indexOf = string.indexOf(StringUtils.LF);
                        if (indexOf < 0) {

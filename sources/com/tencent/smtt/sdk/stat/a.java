...
public class a {
    ...
    public static final byte[] b = {-25, -101, -115, 1, 47, 7, -27, -59, Ascii.DC2, Byte.MIN_VALUE, 123, 79, -44, 37, 46, 115};
    ...
    private static void a(int[] iArr, int i2, int i3, int[][] iArr2) {
        ...
        while (i8 < i9) {
            for (int i10 = 0; i10 < 6; i10++) {
                iArr8[i8][i10] = iArr7[(i8 * 6) + i10];
            }
            iArr9[i8] = l[i8][(iArr8[i8][c2] << 1) + iArr8[i8][5]][(iArr8[i8][1] << 3) + (iArr8[i8][2] << 2) + (iArr8[i8][3] << 1) + iArr8[i8][4]];
            for (int i11 = 0; i11 < 4; i11++) {
                iArr10[((i8 * 4) + 3) - i11] = iArr9[i8] % 2;
                iArr9[i8] = iArr9[i8] / 2;
            }
            i8++;
            i9 = 8;
        ...
        for (int i12 = 0; i12 < 32; i12++) {
            iArr11[i12] = iArr10[k[i12] - 1];
            iArr5[i12] = iArr4[i12];
            iArr6[i12] = iArr3[i12] + iArr11[i12];
            if (iArr6[i12] == 2) {
                iArr6[i12] = 0;
            }
            if ((i5 == 0 && i4 == 0) || (i5 == 1 && i4 == 15)) {
                iArr[i12] = iArr6[i12];
                iArr[i12 + 32] = iArr5[i12];
            } else {
                iArr[i12] = iArr5[i12];
                iArr[i12 + 32] = iArr6[i12];
            }
        }
    }
    ...
    private static int[] a(byte[] r7) {
        ...
        L_0x0040:
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.smtt.sdk.stat.a.a(byte[]):int[]");
    }
    ...
    private static byte[] b(byte[] bArr, byte[] bArr2, int i2) {
        if (bArr.length == 8 && bArr2.length == 8 && (i2 == 1 || i2 == 0)) {
            int[][] iArr = (int[][]) Array.newInstance(int.class, new int[]{16, 48});
            int[] a2 = a(bArr);
            int[] a3 = a(bArr2);
            a(a2, iArr);
            return a(a3, i2, iArr);

...
class MapMakerInternalMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable {
    ...
    MapMakerInternalMap(MapMaker mapMaker) {
        ...
        MapMaker.RemovalListener<K, V> removalListener2 = mapMaker.getRemovalListener();
    ...
    enum EntryFactory {
        ...
        static {
            ...
            factories = new EntryFactory[][]{new EntryFactory[]{entryFactory, entryFactory2, entryFactory3, entryFactory4}, new EntryFactory[0], new EntryFactory[]{entryFactory5, entryFactory6, entryFactory7, r0}};
        }

...
public final class Monitor {
    ...
    public boolean enter(long r6, java.util.concurrent.TimeUnit r8) {
        ...
        L_0x001b:
            java.util.concurrent.TimeUnit r4 = java.util.concurrent.TimeUnit.NANOSECONDS     // Catch:{ InterruptedException -> 0x002e, all -> 0x002b }
            boolean r6 = r8.tryLock(r6, r4)     // Catch:{ InterruptedException -> 0x002e, all -> 0x002b }
    ...
    /* JADX WARNING: Missing exception handler attribute for start block: B:34:0x005e */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public boolean enterWhenUninterruptibly(com.google.common.util.concurrent.Monitor.Guard r9, long r10, java.util.concurrent.TimeUnit r12) {
        /*
            ...
            if (r12 != r8) goto L_0x0078
            java.util.concurrent.locks.ReentrantLock r12 = r8.lock
            long r0 = java.lang.System.nanoTime()
            long r0 = r0 + r10
            boolean r2 = r12.isHeldByCurrentThread()
            boolean r3 = java.lang.Thread.interrupted()
            boolean r4 = r8.fair     // Catch:{ all -> 0x006d }
            r5 = 1
            r6 = 0
            if (r4 != 0) goto L_0x0023
            boolean r4 = r12.tryLock()     // Catch:{ all -> 0x006d }
            if (r4 != 0) goto L_0x003f
        L_0x0023:
            r4 = 0
        L_0x0024:
            java.util.concurrent.TimeUnit r7 = java.util.concurrent.TimeUnit.NANOSECONDS     // Catch:{ InterruptedException -> 0x0036 }
            boolean r4 = r12.tryLock(r10, r7)     // Catch:{ InterruptedException -> 0x0036 }
        ...
        L_0x0036:
            r3 = 1
        L_0x0037:
            long r10 = java.lang.System.nanoTime()     // Catch:{ all -> 0x006d }
            long r10 = r0 - r10
            if (r4 == 0) goto L_0x0024
        L_0x003f:
            boolean r4 = r9.isSatisfied()     // Catch:{ InterruptedException -> 0x005e, all -> 0x005c }
            if (r4 != 0) goto L_0x004d
            boolean r9 = r8.awaitNanos(r9, r10, r2)     // Catch:{ InterruptedException -> 0x005e, all -> 0x005c }
        ...
        L_0x005c:
            ...
            goto L_0x0069
        L_0x005e:
            long r10 = java.lang.System.nanoTime()     // Catch:{ all -> 0x0067 }
            long r10 = r0 - r10
            r2 = 0
            r3 = 1
            goto L_0x003f
    ...
    public boolean waitForUninterruptibly(com.google.common.util.concurrent.Monitor.Guard r6, long r7, java.util.concurrent.TimeUnit r9) {
        ...
        L_0x001d:
            ...
            r4 = 1
        L_0x0027:
            boolean r6 = r5.awaitNanos(r6, r7, r4)     // Catch:{ InterruptedException -> 0x0038, all -> 0x0035 }
        ...
        L_0x0035:
            ...
            goto L_0x0050
        L_0x0038:
            boolean r7 = r6.isSatisfied()     // Catch:{ all -> 0x004f }

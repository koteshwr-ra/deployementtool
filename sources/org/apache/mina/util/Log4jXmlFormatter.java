...
public class Log4jXmlFormatter extends Formatter {
    ...
    public String format(LogRecord logRecord) {
        ...
        if (this.properties && (copyOfContextMap = MDC.getCopyOfContextMap()) != null && (keySet = copyOfContextMap.keySet()) != null && keySet.size() > 0) {
            ...
            for (Object obj : array) {
                ...
                Object obj2 = copyOfContextMap.get(str);
                if (obj2 != null) {
                    this.buf.append("<log4j:data name=\"");
                    this.buf.append(Transform.escapeTags(str));
                    this.buf.append("\" value=\"");
                    this.buf.append(Transform.escapeTags(String.valueOf(obj2)));
                    this.buf.append("\"/>\r\n");
                }
            }
            this.buf.append("</log4j:properties>\r\n");

...
public class NumberUtils {
    ...
    public static boolean isParsable(String str) {
        if (StringUtils.endsWith(str, Consts.DOT)) {
            return false;
        }
        if (StringUtils.startsWith(str, MapFragment.SLASH)) {
            return isDigits(StringUtils.replaceOnce(str.substring(1), Consts.DOT, ""));
        }
        return isDigits(StringUtils.replaceOnce(str, Consts.DOT, ""));
    }
}

...
public final class OpenSSLProvider extends Provider {
    private static final String PREFIX = (OpenSSLProvider.class.getPackage().getName() + Consts.DOT);
    ...
    private void putSymmetricCipherImplClass(String str, String str2) {
        putImplClassWithKeyConstraints("Cipher." + str, PREFIX + str2, (String) null, "RAW");
    }

    private void putRSACipherImplClass(String str, String str2) {
        String str3 = "Cipher." + str;
        putImplClassWithKeyConstraints(str3, PREFIX + str2, PREFIX + "OpenSSLRSAPrivateKey|" + STANDARD_RSA_PRIVATE_KEY_INTERFACE_CLASS_NAME + "|" + PREFIX + "OpenSSLRSAPublicKey|" + STANDARD_RSA_PUBLIC_KEY_INTERFACE_CLASS_NAME, (String) null);
    }
    ...
    private void putRAWRSASignatureImplClass(String str) {
        putImplClassWithKeyConstraints("Signature.NONEwithRSA", PREFIX + str, PREFIX + "OpenSSLRSAPrivateKey|" + STANDARD_RSA_PRIVATE_KEY_INTERFACE_CLASS_NAME + "|" + PREFIX + "OpenSSLRSAPublicKey|" + STANDARD_RSA_PUBLIC_KEY_INTERFACE_CLASS_NAME, (String) null);
    }

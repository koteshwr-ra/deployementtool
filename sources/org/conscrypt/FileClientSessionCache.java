...
public final class FileClientSessionCache {
    ...
    static class Impl implements SSLClientSessionCache {
        ...
        public synchronized byte[] getSessionData(java.lang.String r5, int r6) {
            ...
            L_0x002c:
                ...
                int r3 = (int) r2     // Catch:{ IOException -> 0x0047 }
                byte[] r2 = new byte[r3]     // Catch:{ IOException -> 0x0047 }
        ...
        static void logReadError(String str, File file, Throwable th) {
            ...
            access$000.log(level, "FileClientSessionCache: Error reading session data for " + str + " from " + file + Consts.DOT, th);
        }
        ...
        private void delete(File file) {
            if (!file.delete()) {
                IOException iOException = new IOException("FileClientSessionCache: Failed to delete " + file + Consts.DOT);
                FileClientSessionCache.logger.log(Level.WARNING, iOException.getMessage(), iOException);
            }
            this.size--;
        }
        ...
        static void logWriteError(String str, File file, Throwable th) {
            Logger access$000 = FileClientSessionCache.logger;
            Level level = Level.WARNING;
            access$000.log(level, "FileClientSessionCache: Error writing session data for " + str + " to " + file + Consts.DOT, th);
        }
    }
    ...
    static class CacheFile extends File {
        ...
        public int compareTo(File file) {
            int i = ((lastModified() - file.lastModified()) > 0 ? 1 : ((lastModified() - file.lastModified()) == 0 ? 0 : -1));
            if (i == 0) {

...
final class NativeSsl {
    ...
    public byte[] exportKeyingMaterial(String str, byte[] bArr, int i) throws SSLException {
        if (str != null) {
            return NativeCrypto.SSL_export_keying_material(this.ssl, this, str.getBytes(Charset.forName(CharEncoding.US_ASCII)), bArr, i);
        }
    ...
    public void initialize(String str, OpenSSLKey openSSLKey) throws IOException {
        ...
        if (this.parameters.getEnabledProtocols().length != 0 || !this.parameters.isEnabledProtocolsFiltered) {
            ...
            if (!isClient()) {
                ...
                for (long serverX509KeyType : NativeCrypto.SSL_get_ciphers(this.ssl, this)) {
                    String serverX509KeyType2 = SSLUtils.getServerX509KeyType(serverX509KeyType);
                    if (serverX509KeyType2 != null) {
                        hashSet.add(serverX509KeyType2);
                    }
                }
                X509KeyManager x509KeyManager = this.parameters.getX509KeyManager();
                if (x509KeyManager != null) {
                    for (String chooseServerAlias : hashSet) {
                        try {
                            setCertificate(this.aliasChooser.chooseServerAlias(x509KeyManager, chooseServerAlias));
    ...
    private void setCertificateValidation() throws javax.net.ssl.SSLException {
        /*
            r4 = this;
            boolean r0 = r4.isClient()
            if (r0 != 0) goto L_0x004f
            org.conscrypt.SSLParametersImpl r0 = r4.parameters
            ...
            long r0 = r4.ssl
            r3 = 3
            org.conscrypt.NativeCrypto.SSL_set_verify(r0, r4, r3)
        L_0x0016:
            r1 = 1
            goto L_0x002b
        L_0x0018:
            ...
            long r0 = r4.ssl
            org.conscrypt.NativeCrypto.SSL_set_verify(r0, r4, r2)
            goto L_0x0016
        L_0x0026:
            long r2 = r4.ssl
            org.conscrypt.NativeCrypto.SSL_set_verify(r2, r4, r1)
        L_0x002b:
            ...
            int r1 = r0.length
            if (r1 == 0) goto L_0x004f
            byte[][] r0 = org.conscrypt.SSLUtils.encodeSubjectX509Principals(r0)     // Catch:{ CertificateEncodingException -> 0x0046 }
            long r1 = r4.ssl
            org.conscrypt.NativeCrypto.SSL_set_client_CA_list(r1, r4, r0)
            goto L_0x004f
        L_0x0046:
            r0 = move-exception
            javax.net.ssl.SSLException r1 = new javax.net.ssl.SSLException
            java.lang.String r2 = "Problem encoding principals"
            r1.<init>(r2, r0)
            throw r1
        L_0x004f:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.conscrypt.NativeSsl.setCertificateValidation():void");
    }

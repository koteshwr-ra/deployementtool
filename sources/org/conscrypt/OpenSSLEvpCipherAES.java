...
public abstract class OpenSSLEvpCipherAES extends OpenSSLEvpCipher {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                $SwitchMap$org$conscrypt$OpenSSLCipher$Padding = r0
                r1 = 1
            ...
            L_0x0012:
                r0 = 2
                int[] r2 = $SwitchMap$org$conscrypt$OpenSSLCipher$Padding     // Catch:{ NoSuchFieldError -> 0x001d }
    ...
    public String getCipherName(int i, OpenSSLCipher.Mode mode) {
        return "aes-" + (i * 8) + MapFragment.SLASH + mode.toString().toLowerCase(Locale.US);
    }

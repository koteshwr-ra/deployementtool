...
public final class OpenSSLECKeyPairGenerator extends KeyPairGenerator {
    ...
    static {
        ...
        hashMap.put(Integer.valueOf(TbsListener.ErrorCode.EXCEED_INCR_UPDATE), "secp224r1");
    ...
    public static void assertCurvesAreValid() {
        ...
        for (String next : SIZE_TO_CURVE_NAME.values()) {
            if (OpenSSLECGroupContext.getCurveByName(next) == null) {
                arrayList.add(next);
            }
        }
        if (arrayList.size() > 0) {

...
public final class Headers implements Iterable<Pair<? extends String, ? extends String>>, KMappedMarker {
    ...
    public final int m1624deprecated_size() {
        return size();
    }
    ...
    public static final class Companion {
        ...
        public final Headers m1626deprecated_of(String... strArr) {
            Intrinsics.checkParameterIsNotNull(strArr, "namesAndValues");
        ...
        /* renamed from: -deprecated_of  reason: not valid java name */
        public final Headers m1625deprecated_of(Map<String, String> map) {

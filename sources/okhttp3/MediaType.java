...
public final class MediaType {
    ...
    public final String m1651deprecated_type() {
        return this.type;
    }
    ...
    public final String m1650deprecated_subtype() {
        return this.subtype;
    }
    ...
    public static final class Companion {
        ...
        public final MediaType m1652deprecated_get(String str) {
        ...
        public final MediaType m1653deprecated_parse(String str) {
            Intrinsics.checkParameterIsNotNull(str, "mediaType");
            return parse(str);
        }
    }
